...
declare type UseEventEventName = keyof GlobalEventHandlersEventMap | string[];
declare type UseEventEvent<N extends UseEventEventName, D> = N extends keyof GlobalEventHandlersEventMap ? GlobalEventHandlersEventMap[N] : D;
/**
