...
export declare const VaSelect: import("vue").DefineComponent<{
    ...
    optionList: import("vue").ShallowRef<import("vue").DefineComponent<{
        ...
        beforeUpdate: () => void;
        setItemRef: (option: import("./types").SelectOption) => (el: Element | import("vue").ComponentPublicInstance<{}, {}, {}, {}, {}, {}, {}, {}, false, import("vue").ComponentOptionsBase<any, any, any, any, any, any, any, any, any, {}>> | null) => void;
        selectOption: (option: import("./types").SelectOption) => void;
        getOptionIcon: (option: import("./types").SelectOption) => string | undefined;
        getOptionClass: (option: import("./types").SelectOption) => {
            'va-select-option-list__option': boolean;
            'va-select-option-list__option--selected': boolean;
        };
        getOptionStyle: (option: import("./types").SelectOption) => {
            color: string;
    ...
    hoveredOption: import("vue").Ref<string | number | {
        [x: string]: any;
    } | null>;
    tabIndexComputed: import("vue").ComputedRef<number>;
