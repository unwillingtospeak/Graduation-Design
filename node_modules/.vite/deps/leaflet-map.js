    ...
    (function(window2, document2, undefined) {
      ...
      L.extend(L.DomEvent, {
        ...
        removeDoubleTapListener: function(obj, id) {
          ...
          (L.Browser.pointer ? document2.documentElement : obj).removeEventListener(this._touchend, obj[pre + this._touchend + id], false);
          if (L.Browser.pointer) {
            document2.documentElement.removeEventListener(L.DomEvent.POINTER_CANCEL, obj[pre + this._touchend + id], false);
          }
          return this;
        }
      });
...
// dep:leaflet-map
var leaflet_map_default = require_leaflet_map();
export {
  leaflet_map_default as default
};
