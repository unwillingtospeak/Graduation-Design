          ...
          setTargetBlank: function(el, anchorUrl) {
            ...
            if (el.nodeName.toLowerCase() === "a") {
              ...
              for (i = 0; i < el.length; i += 1) {
                if (url === false || url === el[i].attributes.href.value) {
                  el[i].target = "_blank";
      ...
      (function() {
        ...
        var AnchorForm = MediumEditor.extensions.form.extend({
          ...
          checkLinkFormat: function(value) {
            ...
            return scheme + this.ensureEncodedUri(path) + (query === void 0 ? "" : "?" + this.ensureEncodedQuery(query)) + (fragment === void 0 ? "" : "#" + fragment);
          },
        ...
        var KeyboardCommands = MediumEditor.Extension.extend({
          ...
          handleKeydown: function(event) {
            ...
            this.keys[keyCode].forEach(function(data) {
              if (data.meta === isMeta && data.shift === isShift && (data.alt === isAlt || data.alt === void 0)) {
                event.preventDefault();
                event.stopPropagation();
      ...
      (function() {
        ...
        var PasteHandler = MediumEditor.Extension.extend({
          ...
          pasteHTML: function(html, options) {
            ...
            for (i = 0; i < elList.length; i += 1) {
              workEl = elList[i];
              if (workEl.nodeName.toLowerCase() === "a" && this.getEditorOption("targetBlank")) {
...
// dep:medium-editor
var medium_editor_default = require_medium_editor();
export {
  medium_editor_default as default
};
